export const translations = {
  zh: {
    ...
    home: {
      ...
      venue: "比赛场地",
      noPlayers: "暂无球员",
      addPlayersHint: "请在管理后台添加球员",
      tieMessage: "积分相同时，依次按夺冠次数、出赛场数及姓名排序",
      otherPlayers: "其他球员",
      shareRankings: "分享排名",
    },
    showcase: {
      headline: "追踪每一拍。",
      subline: "积分、连冠奖励与比赛记录，一目了然。",
      cta: "查看排名",
    },
    podium: {
      topPlayers: "前三甲",
    ...
    admin: {
      title: "管理面板",
      description: "管理球员、比赛与成绩",
      totalPlayers: "球员人数",
      sessionsPlayed: "已赛场数",
      championships: "夺冠次数",
      pointsAwarded: "累计积分",
      managePlayers: "球员管理",
      playersRegistered: "位球员",
      enterPlayerName: "输入球员姓名",
      add: "添加",
      noPlayersYet: "暂无球员",
      addFirstPlayer: "添加第一位球员开始比赛",
      deletePlayerConfirm: "删除球员",
      newSession: "新增比赛",
      createAndRecord: "新增比赛并录入成绩",
      cancel: "取消",
      threeTeams: "3队模式",
      twoTeams: "2队模式",
      champion: "冠军",
      ...
      sessionType: "比赛形式",
      date: "日期",
      nameOptional: "比赛名称（可选）",
      continueToResults: "下一步：录入成绩",
      tapToCycle: "点击球员切换成绩：",
      saveResults: "保存成绩",
      saving: "保存中...",
      sessionHistory: "比赛记录",
      sessionsRecorded: "场比赛已记录",
      noSessionsYet: "暂无比赛记录",
      createFirstSession: "新增第一场比赛开始记录",
      champions: "冠军",
      runnerUps: "亚军",
      totalPoints: "总积分",
      noResults: "尚未录入成绩",
      ...
      playerAdded: "球员已添加",
      playerDeleted: "球员已删除",
      sessionCreated: "比赛已新增，请录入成绩",
      resultsRecorded: "成绩已保存",
      resultsUpdated: "成绩已更新",
      avatarUpdated: "头像已更新",
      nameUpdated: "名称已更新",
      selectChampion: "请至少选择一位冠军",
      pleaseEnterName: "请输入球员姓名",
      nameCannotBeEmpty: "名称不能为空",
      pts: "分",
      pt: "分",
      deleteConfirmTitle: "删除球员",
      deleteConfirmMessage: "？该球员的所有比赛成绩也会一并删除。",
      deleteSessionConfirm: "确定删除这场比赛及所有成绩吗？",
      uploadPhoto: "上传合影",
      changePhoto: "更换合影",
      removePhoto: "删除合影",
  ...
  en: {
    ...
    home: {
      ...
      tieMessage: "Ties are decided by titles won, matches played, then player name",
      otherPlayers: "Other Players",
      shareRankings: "Share Rankings",
    },
    showcase: {
      headline: "Track every rally.",
      subline: "Points, title streak bonuses, and match history — all in one place.",
      cta: "See Rankings",
    },
    podium: {
    ...
    history: {
      title: "Match History",
      subtitle: "Results and highlights from every match",
      noSessions: "No matches recorded yet",
      groupPhoto: "Post-match Photo",
    },
    highlights: {
    ...
    admin: {
      title: "Admin Panel",
      description: "Manage players, matches, and results",
      totalPlayers: "Total Players",
      sessionsPlayed: "Matches Played",
      ...
      addFirstPlayer: "Add the first player to get started",
      deletePlayerConfirm: "Delete player",
      newSession: "Add Match",
      createAndRecord: "Add match and record results",
      cancel: "Cancel",
      threeTeams: "3 Teams",
      twoTeams: "2 Teams",
      champion: "Champion",
      runnerUp: "Runner-up",
      attendance: "Played",
      sessionType: "Match Format",
      date: "Date",
      nameOptional: "Match name (optional)",
      continueToResults: "Next: Record Results",
      tapToCycle: "Tap a player to change their result:",
      saveResults: "Save Results",
      saving: "Saving…",
      sessionHistory: "Match History",
      sessionsRecorded: "matches recorded",
      noSessionsYet: "No matches recorded yet",
      createFirstSession: "Add your first match to get started",
      champions: "Champions",
      runnerUps: "Runner-ups",
      totalPoints: "Total points",
      noResults: "Results not recorded yet",
      editResults: "Edit Match Results",
      updateResults: "Update Results",
      playerAdded: "Player added",
      playerDeleted: "Player deleted",
      sessionCreated: "Match added. Now record the results.",
      resultsRecorded: "Results saved",
      ...
      deleteSessionConfirm: "Delete this match and all its results?",
